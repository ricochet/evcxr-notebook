#!/usr/bin/env bash
#
# Modified rust-debian.sh from upstream to install cargo in USERNAME $HOME.
# Additionally installs cargo crates needed for rust notebooks.
#
...
export CARGO_HOME=${2:-"/usr/local/cargo"}
...
echo "Installing with user ${USERNAME}"
